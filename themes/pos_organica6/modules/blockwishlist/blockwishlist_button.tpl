...
{else}
	...
	<a class="addToWishlist wishlistProd_{$product.id_product|intval}" href="#" title="{l s='Add to wishlist' mod='blockwishlist'}" data-rel="{$product.id_product|intval}" onclick="WishlistCart('wishlist_block_list', 'add', '{$product.id_product|intval}', false, 1); return false;">
		{l s="Add to Wishlist" mod='blockwishlist'}
	</a>
