	...
	<h4>{l s='My account' mod='blockmyaccountfooter'}</h4>
		<ul class="block_content toggle-footer">
			<!-- <li><a class="link-checkout" href="{$link->getPageLink('order', true)|escape:'html'}" title="{l s='checkout' mod='blockuserinfo'}">
				{l s='checkout' mod='blockmyaccountfooter'}
			</a></li> -->
			<li><a href="{$link->getPageLink('my-account', true)|escape:'html':'UTF-8'}" title="{l s='Manage my customer account' mod='blockmyaccountfooter'}" rel="nofollow">{l s='My account' mod='blockmyaccountfooter'}</a></li>
