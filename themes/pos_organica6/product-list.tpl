				...
				<div class="left-block">
					<div class="product-image-container">
						<div class="products-inner">
							<a class=" product_image product_img_link" href="{$product.link|escape:'html':'UTF-8'}" title="{$product.name|escape:'html':'UTF-8'}" itemprop="url">
							...
							{if isset($product.new) && $product.specific_prices} 
								{if $product.specific_prices}<span class="sale-box">{l s='Sale'}</span>{/if}
							{else}
