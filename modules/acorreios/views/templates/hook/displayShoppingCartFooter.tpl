...
<input class="acorreios-mask-cep acorreios-col-lg-15" type="text" id="acorreios_cep" placeholder="" value="{$acorreios['cepCookie']}" style="padding:5px;"/>
            <input class="btn-primary" style="padding:5px;" type="button" onclick="acorreios_enviar_carrinho()" name="btnSubmit" value="{l s='Calcular Frete' mod='acorreios'}"/> </P>
