...
class CheckoutDeliveryStepCore extends AbstractCheckoutStep
{
    ...
    public function render(array $extraParams = array())
    {
        ...
        $lista = $this->getCheckoutSession()->getDeliveryOptions();

        try
        {
            $lista=ACorreios::refaz_lista($lista);
        }
        catch(Exception $e)
        {
            $lista = $this->getCheckoutSession()->getDeliveryOptions(); 
        ...
        try{
            $opcao = $this->getCheckoutSession()->getSelectedDeliveryOption();
        }
        catch(Exception $e)
        {
            $opcao = '';
        ...
        try{
            $mensagem = $this->getCheckoutSession()->getMessage();
        }
        catch(Exception $e) 
        {
            $mensagem=' ';
