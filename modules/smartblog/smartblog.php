...
<script type="text/javascript">
    ...
    public function SampleDataInstall()  {
			...
			$damisql11 ="INSERT IGNORE INTO `"._DB_PREFIX_."meta` (`id_meta`, `page`, `configurable`) 
			VALUES(NULL, 'products-comparison', '1'),
				(NULL, 'cms', '0'),
				(NULL, 'category', '0'),
				(NULL, 'product', '0'),
			...
			SELECT `"._DB_PREFIX_."theme`.`id_theme` , `"._DB_PREFIX_."meta`.`id_meta` , `default_left_column` , `default_right_column`FROM `"._DB_PREFIX_."theme` , `"._DB_PREFIX_."meta`;";
			Db::getInstance()->execute($damisql11);
