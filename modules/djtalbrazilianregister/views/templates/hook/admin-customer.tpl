...
<div class="col-lg-6">
    <div class="panel">
        <div class="panel-heading">
            <i class="icon-file-text"></i> {l s='CPF - CNPJ' mod='djtalbrazilianregister' }
        </div>
        <p class="text-muted text-left">
            ...
            <strong>IE:</strong> {$br_document_ie|escape:'htmlall':'UTF-8'} <br />
            <strong>Razão Social:</strong> {$br_document_sr|escape:'htmlall':'UTF-8'} <br />
            <strong>Complementary Question:</strong> {$br_document_comp|escape:'htmlall':'UTF-8'}
        </p>
    </div>
</div>
