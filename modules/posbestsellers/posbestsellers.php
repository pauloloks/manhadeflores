...
class posbestsellers extends Module
{
	...
	public function install()
	{
		...
		if (!parent::install()
			...
			|| !Configuration::updateValue('POS_FEATURED_NBR',20)
			|| !Configuration::updateValue('PRODUCT_ITEM',3)
			|| !Configuration::updateValue('PRODUCT_ROW',2)
		...
		if ((!$theme->default_left_column || !$this->registerHook('blockPosition1'))
		)
		{
	...
	public function getContent()
	{
		...
		if (Tools::isSubmit('submitBestSellers'))
		{
			...
			Configuration::updateValue('POS_FEATURED_NBR', (int)Tools::getValue('POS_FEATURED_NBR'));
			Configuration::updateValue('PRODUCT_ITEM', (int)Tools::getValue('PRODUCT_ITEM'));
			Configuration::updateValue('PRODUCT_ROW', (int)Tools::getValue('PRODUCT_ROW'));
	...
	public function renderForm()
	{
		$fields_form = array(
			'form' => array(
				...
				'input' => array(
					...
					array(
						'type'=>'text',
						'label'=>$this->l('Display number product'),
						'name'=>'POS_FEATURED_NBR',
		...
		$helper->tpl_vars = array(
			...
			'COL' => Tools::getValue('COL',Configuration::get('COL')),
			'POS_FEATURED_NBR' => Tools::getValue('POS_FEATURED_NBR',Configuration::get('POS_FEATURED_NBR')),
			'PRODUCT_ITEM' => Tools::getValue('PRODUCT_ITEM',Configuration::get('PRODUCT_ITEM')),
			'PRODUCT_ROW' => Tools::getValue('PRODUCT_ROW',Configuration::get('PRODUCT_ROW'))
			),
	...
	public function hookblockPosition1($params)
	{
		if (!$this->isCached('posbestsellers.tpl', $this->getCacheId('posbestsellers-col')))
		{
			...
			$this->smarty->assign(array(
				...
				'nbr' =>Configuration::get('POS_FEATURED_NBR'),
				'item' =>Configuration::get('PRODUCT_ITEM'),
				'row' =>Configuration::get('PRODUCT_ROW'),
			));
		}
	...
	public function hookdisplayLeftColumn($params)
	{
		...
		return $this->display(__FILE__, 'posbestsellers_product.tpl', $this->getCacheId('posbestsellers-col'));
	}
	...
	protected function getBestSellers($params)
	{
		if (Configuration::get('PS_CATALOG_MODE'))
			return false;
		$NBR = Configuration::get('POS_FEATURED_NBR');
		if (!($result = ProductSale::getBestSalesLight((int)$params['cookie']->id_lang, 0, $NBR)))
