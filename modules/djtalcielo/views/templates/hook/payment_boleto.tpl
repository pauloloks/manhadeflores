...
<div class='row'>
    <div class='col-xs-12 col-md-12'>
        <p class='payment_module' id='djtalcielo_payment_button'>
            <a href='{$link->getModuleLink('djtalcielo', 'Paymentboleto', array(), true)|escape:'htmlall':'UTF-8'}' title='{l s='Pay with cielo' mod='djtalcielo'}'>
                ...
                {l s='Pay with Boleto' mod='djtalcielo'}
            </a>
        </p>
    </div>
</div>
