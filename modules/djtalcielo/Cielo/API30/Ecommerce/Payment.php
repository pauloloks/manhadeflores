...
class Payment implements \JsonSerializable {
    ...
    public function populate(\stdClass $data) {
        ...
        if (isset($data->BoletoNumber)) {
            $this->Boleto = new Boleto();
            $this->Boleto->populate($data);
        }
    ...
    function setDebitCard($debitCard) {
        $this->setType(self::PAYMENTTYPE_DEBITCARD);
        $this->debitCard = $debitCard;
        return $this;
    }

    public function Boleto($provider) {
        $boleto = new Boleto();
        $boleto->setProvider($provider);

        $this->setType(self::PAYMENTTYPE_BOLETO);
