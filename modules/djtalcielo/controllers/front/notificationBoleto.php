...
use Cielo\API30\Ecommerce\Boleto;
...
class DjtalcieloNotificationBoletoModuleFrontController extends ModuleFrontController {
    ...
    public function postProcess() {
        ...
        $id_cart = Tools::getValue('numOrder');
        
        $auth = cieloAuthorization::getCieloAuthByCartId($id_cart);
        ...
        //$receivedDate = $transaction->getPayment()->getReceivedDate();
        //$expirationDate = $transaction->getPayment()->Boleto->getExpirationDate();
