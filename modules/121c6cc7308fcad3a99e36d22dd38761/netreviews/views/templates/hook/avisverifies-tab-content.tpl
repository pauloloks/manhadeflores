         ...
         <div class="netreviews_global_rating_details">
            <ul class="netreviews_rates_list">
               ...
               <li class="netreviews_rate_list_item {if $review_portion > 0}cursorp{/if}" {if $review_portion > 0} onclick="javascript:netreviewsFilter({$reviews_rate_portion_key|escape:'htmlall':'UTF-8'});" {/if} >
                  <span class="av_star_index">{$reviews_rate_portion_key|escape:'htmlall':'UTF-8'}</span>
                  {if $use_image}<img src="{$modules_dir|escape:'htmlall':'UTF-8'}netreviews/views/img/star-gold-16.png" height="15px" width="15px" alt="" />{else}<div class="nr-icon nr-star gold"></div>{/if}
                  <div class="netreviews_rate_graph">
                     <span class="netreviews_rate_percent" style="height:{if $review_portion > 0}{math equation='a/b*100' a=$review_portion b=$count_reviews}{else}1{/if}%">
